            ...
            <section>
                    ...
                    <div class="row">
                        <div class="image_contact col m-auto text-center">
                            <h1 class="text-white">КОИ СМЕ НИЕ?</h1>
                        </div>
                    </div>
